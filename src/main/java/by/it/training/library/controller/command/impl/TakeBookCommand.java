...
public class TakeBookCommand extends BaseBookCommand {
            ...
            try {
                ...
                if (Objects.isNull(parameter)){
                    ...
                    subscriptionService.addSubscription(
                            new SubscriptionBean(-1, user.getId(), bookId, Timestamp.from(Instant.now()), null, null, "", 0));
                } else {
                    ...
                    subscription.setStarting(Timestamp.from(Instant.now()));

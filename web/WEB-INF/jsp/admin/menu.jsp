...
<a href="main?command=readers"><fmt:message bundle="${requestScope.language}" key="main.readers"/></a><br>
<a href="main?command=subscriptions"><fmt:message bundle="${requestScope.language}" key="main.subscriptions"/></a><br>
